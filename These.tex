...
%%%%% Citation En Ligne
\newcommand{\ciel}[1]{\emph{\gui{#1}}}

%%%%% Commentaires
\newcommand{\co}[1]{\textcolor{black!70}{#1}}

%%%%% Un bout de code
\newcommand{\cd}[1]{\textcolor{black!70}{\texttt{#1}}}
\newcommand{\con}[1]{\textcolor{SteelBlue}{\textbf{\textsc{#1}}}}
\newcommand{\rel}[1]{\textcolor{LightSlateGrey}{\textbf{\texttt{#1}}}}
...
%%%%% Encadré coloré
\newenvironment{problemes}[1]
{%
	\setlength\fboxrule{1pt}%
	\def\FrameCommand{\fboxsep=\FrameSep\fcolorbox{SteelBlue}{#1}}%
	\MakeFramed{\FrameRestore}%
}{%
	\endMakeFramed
}
\definecolor{fond}{rgb}{69,162,1}

% \definecolor{bbleu}{rgb}{31,127,135}
...
{%
	...
	\setlength{\topsep}{0em}%
	\setlength{\partopsep}{0em}%
	\def\FrameCommand{\fboxsep=\FrameSep\fcolorbox{White}{#1}}%
	\MakeFramed{\FrameRestore}%
}{%u
	\endMakeFramed
}
...
\hyphenation{audio-visuel inter-com-pré-hen-sion infor-ma-ti-sation appa-reil exploi-ta-tion impli-ca-tion ingé-nie-rie métho-de enregi-stre-ment hypo-thèse inter-pré-ta-tion igno-ran-ce in-for-ma-tion}
