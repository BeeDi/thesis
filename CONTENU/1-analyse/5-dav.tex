...
\g{Dimension de la conservation}
	\begin{liste}
...
L'utilisation de code temporel (\ciel{timecode}) permet de marquer l'écoulement du temps et de réaliser cette synchronisation des flux.
...
Ces questions sont traitées dans les domaines des hypermédia adaptatifs \parcite{Balpe1990}, de la modélisation utilisateur et des documents virtuels personnalisables \parcite{Leleu-Merviel2004}. \cite{Iksal2002} a réalisé une étude approfondie de ces questions et \cite{Garlatti2004} détaillent leur fonctionnement dans le cadre du projet d'un Web sémantique.
...
\begin{liste}
	...
	\item Les systèmes \g{adaptatifs} qui reposent sur l'observation de l'utilisateur pour déduire ses connaissances et préférences. 
...
La caractérisation de ces différents niveaux nous renvoit aux besoins en modélisations exprimés en \ref{sec:bm-av} (\g{B1 : autonomie} et \g{B2 : réutilisabilité}).
