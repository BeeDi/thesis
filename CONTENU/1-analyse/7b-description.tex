...
Les Segments ainsi constitués renvoient alors au premier des trois niveaux de modélisation de MPEG-7, à savoir \pc{ContentEntity}, \pc{MediaProfile} et \pc{MediaInstance}.
...
De ce point de vue, MPEG-7 définit une classification par genre et permet de typer les Segments suivant leur place dans la structure de présentation du contenu.
...
En tant que CE, chacun des Segment d'une décomposition peut-être décrit par les schémas de descriptions et le schéma Semantic DS [\g{B2 : réutilisabilité}].
...
Les exemples développés traitent par exemple de sport et constituent une voie prometteuse pour l'enrichissement des descriptions.
...
% Pour autant, ces modélisations ne fournissent pas de connaissances propres à la production audiovisuelle, comme celles représentées dans les modèles de la pré-production (voir \ref{sec:plan}).
