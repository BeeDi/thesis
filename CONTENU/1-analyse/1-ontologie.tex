...
Pour les ontologies, nous en distinguerons différentes types et présenterons une méthode de construction qui permet d'éclairer la distinction entre une modélisation et sa représentation informatique (\ref{sec:construction}).
...
\begin{listeni}
	\item l'\g{objectif} de l'ontologie (purpose) où l'on distingue entre deux objectifs, servir de référence ou bien être utilisée dans un cas d'application :
	\begin{liste}
		\item l'\e{ontologie de référence} vise à établir un consensus entre des agents (humains, machines) d'une même communauté, ou bien à servir d'explication et de langage commun avec des agents de communautés différentes. 
