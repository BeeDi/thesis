...
\paragraph{Sémantique et classification d'ontologie}
...
Il est alors utile de caractériser différentes propriétés pour distinguer des "types" d'ontologies et les raccorder à des usages précis. 
S'il existe de nombreuses manière de caractériser les ontologies, nous trouvons celle d'\cite{Oberle2006} particulièrement éclairante. 
Cette classification repose sur trois propriétés : 
\begin{liste}
	...
	\end{liste}
	La différence réside dans l'arbitrage entre l'expressivité de la représentation et sa décidabilité (indigo\cite{Borgo2002}). 
