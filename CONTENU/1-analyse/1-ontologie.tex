...
\newpage
\section{Les Systèmes d'Organisation de Connaissances (m)}\label{sec:defs}
...
% pourquoi ? 
% Lien avec les ontologies (section suivante)


\subsection{Thésaurus, terminologie, ontologie (m)}\label{sec:tto}
