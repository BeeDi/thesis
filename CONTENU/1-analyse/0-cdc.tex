...
Ensuite, pour les amateurs, la terminologie est enrichie par des illustrations [\g{$\delta_2$ : documentation}]. Enfin, un nouveau concept de cadrage est ajouté (plan américain large ou plan moyen serré) [\g{$\delta_3$ : gestion, évolution}] en vue d'une nouvelle coopération avec la VRT. En plus de cela, le problème de la langue (français et flamand) s'ajoute à la question des jargons métiers. 
