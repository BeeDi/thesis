...
%=============
\subsubsection{MPEG-7 Part 5: Multimedia Description Scheme}
...
Développé à partir de 1998 par le comité MPEG (Moving Picture Expert Group) à la suite des standards MPEG-1, MPEG-2 (norme de compression du signal audiovisuel) et MPEG-4 (norme de représentation des contenus multimédia), MPEG-7 est devenu une norme ISO/IEC en 2001 puis mise à jour jusqu'en 2006. 
...
\paragraph{Gestion du contenu}
\begin{liste}
	\item UserDescription
	\item CreationDescription 
	\item UsageDescription 
	\item ClassificationSchemeDescription 
	\item MediaDescription
\end{liste}

\paragraph{Entités de contenu}
\begin{liste}
	\item Image
	\item Video
	\item Audio
...
\paragraph{L'abstraction du contenu}
\begin{liste}
...
\paragraph{Travaux dans la lignée de MPEG-7}
