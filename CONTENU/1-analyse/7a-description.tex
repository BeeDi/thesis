...
Nous distinguons parmi les modèles qui suivent une approche dite \e{in situ} de modélisation des connaissances des professionnels (\ref{sec:plan}) et ceux qui suivent une approche de fabrication des descriptions se déroulant généralement \e{a posteriori} (\ref{sec:post}).}
