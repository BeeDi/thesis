...
%====================================================
\newpage
\section{Décrire les objets audiovisuels}\label{sec:desc}
\e{
...
Notons enfin que l'approche \e{in situ} consiste à collecter les informations fabriquées durant la production. 
...
Nous distinguons parmi les modèles qui suivent une approche dite \e{in situ} de modélisation des connaissances des professionnels (\ref{sec:insitu}) et ceux qui suivent une approche de fabrication des descriptions se déroulant généralement \e{a posteriori} (\ref{sec:post}).}
