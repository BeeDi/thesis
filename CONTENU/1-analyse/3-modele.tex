...
<owl:Class rdf:ID='Nationality'>
	...
	\item an intersection of several classes descriptions
	\item an union of several classes descriptions
	\item a complement of a class description
\end{liste}

We may also use more complex property restrictions, including value or  cardinality restrictions. For this purpose we have a set of properties:
