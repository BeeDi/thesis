...
La fonction d'échange se banalise et inversement, les appareils communicant comme les téléphones deviennent eux-même des stations multimédias à part entière, musique, photo, vidéo, courriel, sms etc.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Organisation du mémoire (n,i)}\label{sec:plan}
\addcontentsline{toc}{section}{Organisation du mémoire (n,i)}
...
Le chapitre \g{\ref{chap:intro}. Introduction} nous a sert à rappeler le contexte technologique général qui s'impose au monde de l'audiovisuel. 
...
\e{
La deuxième partie de ce mémoire vise à étudier des outils, méthodes et langages de modélisation. Elle permet également d'étudier les modélisations existantes des objets audiovisuels, mais égalements des connaissances qui y sont associées afin de faciliter leur exploitation.}

Le chapitre \g{\ref{chap:omod}. Outils de modélisation} commence par clarifier les définitions des concepts de \gui{systèmes d'organisation de connaissances} (soc) et en particulier les relations qu'entretiennent \gui{terminologie} et d'\gui{ontologie}.

Le chapitre \g{\ref{chap:mav}. Modélisation de l'audiovisuel}

\paragraph{Contribution}
Le chapitre \g{\ref{chap:mod}. Approche et modélisation}

Le chapitre \g{\ref{chap:op}. Mise en oeuvre}



\paragraph{Discussion}
Le chapitre \g{\ref{chap:app}. Applications et validation}
