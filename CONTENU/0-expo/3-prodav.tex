...
\e{
L'objectif de cette première section est de donner des éléments de compréhension des métiers de la production audiovisuelle.
...
\e{
Dans cette section, nous présentons des définitions utilisées dans le milieu professionnel et tirées du \ciel{Dictionnaire technique du Cinéma (\cite{Pinel2008})} afin de présenter les principaux documents et le vocabulaire utilisé pendant la phase de préproduction. 
...
Du point de vue technique, il s'agit d'une série d'images (ou photogrammes) qui sont enregistrées par un appareil de capatation (une caméra) au cours d'une même prise de vue : \ciel{série de photogrammes enregistrés au cours d'une même prise} (\cite{Pinel2008}).
...
\begin{liste}
	...
	\item Un \g{niveau dont le plan est l'unité de base qui sert tout au long de la chaîne de production}. 
...
\begin{liste}
	...
	\item \g{L'articulation des plans entre eux}, d'une part en terme de durée, mais aussi en termes de transition et d'impression de continuité entre les plans. 
