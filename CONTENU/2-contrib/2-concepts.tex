...
\begin{liste}
	...
	De manière générale, le décodage d'une manifestation matérielle produit forme perceptible (\con{ContentObject}), ce qui dans le cas du matériel audio ou audio-visuel peut être représenté par une forme temporelle (\con{TemporalObject}).
	...
	De manière générale, cette forme sémiotique représente le résultat d'un travail artistique, intellectuelle, technique (\con{Opus}).
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{./images/SO-CR-DAV-v1.png}
