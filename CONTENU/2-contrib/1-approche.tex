...
Nous avons ensuite examiné des modélisations de l'audiovisuel que l'on a distingué en deux approches, \e{in situ} et \e{a posteriori}, que nous jugeons complémentaires. 
...
\e{
	La production audiovisuelle et les modèles \e{in situ} posent le plan comme l'unité de base qui structure à la fois le processus de production audiovisuelle et les échanges entre ses contributeurs, de même que les mécanismes de narration propre aux documents audiovisuels.
...
\e{
	Par ailleurs, les modèles \e{a posteriori} ont largement formalisé et développé la description du matériel audiovisuel par des procédés d'analyse automatique du signal.
