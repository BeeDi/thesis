...
La Figure \ref{img:arch-process} montre trois grandes étapes de production du scénario en vue d'illustrer \co{sa mise en oeuvre avec les applications développés dans le cadre du projet MediaMap}. 
...
La Figure \ref{img:arch-apps} reprend la numérotation du scénario et propose une vue alternative centrée sur les applications et les flux de données entre elles. 
