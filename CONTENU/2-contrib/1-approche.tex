...
Nous discutons ensuite de la mise en oeuvre de ces patrons (\ref{sec:moe}), qu'il s'agisse de les représenter dans un langage informatique, de donner des exemples d'instanciations ou de spécialisations ou encore de documenter le modèle afin de faciliter l'accès et l'échange des connaissances qu'il exprime.
}
